      ...
      <section style={{ padding: '100px 0' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '40px' }}>
            {content.collections.news.map((item: any, i: number) => (
              <ScrollReveal key={item.id} delay={i * 0.1}>
                <div className="glass-effect" style={{ borderRadius: '24px', overflow: 'hidden', height: '100%', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <div style={{ padding: '32px' }}>
                    ...
                    <button className="text-link" style={{ color: 'var(--teal)' }}>Read Article →</button>
                  </div>
                </div>
              </ScrollReveal>
            ))}
          ...
          {content.collections.news.length === 0 && (
            <ScrollReveal>
